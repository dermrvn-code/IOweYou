...
public interface IBalanceRepository : IDbManagement<Models.Transactions.Balance>
{
    ...
    Task<List<IGrouping<Models.User, Models.Transactions.Balance>>> GetBalancesFromUserGrouped(Models.User user,
        bool excludeZeros);

    Task<List<Models.Transactions.Balance>> GetBalancesFromUser(Models.User user, bool excludeZeros);

    Task<List<Models.Transactions.Balance>> GetBalancesToUser(Models.User fromUser, Models.User toUser,
        bool excludeZeros);
}